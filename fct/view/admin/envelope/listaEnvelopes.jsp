	...
	<div class="grid_12">
		...
		<div class="bottom-spacing">
			...
			<div class="float-right">
				<a
					href="${pageContext.request.contextPath}/view/admin/envelope/cadastroEnvelope.do?ps=0"
			...
			<form action="buscaEnvelopes.do" method="post">
					<fieldset>
			...
			<div class="module-table-body">
				<form action="">
					<table id="myTable" class="tablesorter">
						<thead>
							<tr>
								<th style="width: 45%"><fmt:message key="professor"/></th>
								<th style="width: 45%"><fmt:message key="secretaria"/></th>
								<th style="width: 10%"><fmt:message key="acoes"/></th>
							</tr>
						</thead>
						<tbody>
							<c:forEach var="envelope" items="${envelopes}"  varStatus="i" begin="${inicio}" end="${fim}">
								<tr>
