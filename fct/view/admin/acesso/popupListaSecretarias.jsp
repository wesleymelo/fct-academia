...
<!--  CSS  datepicked-->
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/view/css/jquery.ui.all.css"
	media="screen" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/view/css/jquery-ui-1.8.14.custom.css"
	type="text/css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/view/css/jquery.ui.timepicker.css?v=0.3.0"
	type="text/css" />
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/view/js/jquery-1.7.2.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/view/js/datepicker/jquery.ui.core.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/view/js/datepicker/jquery.ui.widget.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/view/js/datepicker/jquery.ui.datepicker.js"></script>

<script type="text/javascript"
	src="${pageContext.request.contextPath}/view/js/jquery-1.5.1.min.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/view/js/jquery.ui.core.min.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/view/js/jquery.ui.widget.min.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/view/js/jquery.ui.tabs.min.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/view/js/jquery.ui.position.min.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/view/js/jquery.ui.timepicker.js?v=0.3.0"></script>
<script type="text/javascript"
	src="https://apis.google.com/js/plusone.js"></script>

<script
	src="${pageContext.request.contextPath}/view/js/jquery.bgiframe-2.1.2.js"></script>
<script
	src="${pageContext.request.contextPath}/view/js/jquery.ui.core.js"></script>
<script
	src="${pageContext.request.contextPath}/view/js/jquery.ui.widget.js"></script>
<script
	src="${pageContext.request.contextPath}/view/js/jquery.ui.mouse.js"></script>
<script
	src="${pageContext.request.contextPath}/view/js/jquery.ui.button.js"></script>
<script
	src="${pageContext.request.contextPath}/view/js/jquery.ui.draggable.js"></script>
<script
	src="${pageContext.request.contextPath}/view/js/jquery.ui.position.js"></script>
<script
	src="${pageContext.request.contextPath}/view/js/jquery.ui.resizable.js"></script>
<script
	src="${pageContext.request.contextPath}/view/js/jquery.ui.dialog.js"></script>
...
function retorna(id, nome)
        {
           ...
           window.self.close();
		   window.opener.document.getElementById('idSecretaria').value = id;
		   window.opener.document.getElementById('secretaria').value = nome;
        }
</script>
...
<body>
	...
	<form action="buscaSecretariaAcesso.do" method="post">
		<fieldset>
			<b><fmt:message key="nome" /></b> <input type="text" name="busca"
				class="input-medium" />&nbsp;&nbsp;<input class="submit-green"
		...
		<div class="module-table-body">
			<form action="">
				<table id="myTable" class="tablesorter">
					...
					<tbody>
						<c:forEach var="secretaria" items="${secretarias}" varStatus="i"
							begin="${inicio}" end="${fim}">
							<tr>
								<td>${secretaria.idPessoa}</td>
								<td><a href="javascript:retorna('${secretaria.idPessoa}', '${secretaria.nome}');">${secretaria.nome}</a></td>
								<td>${secretaria.cpf}</td>
								<td>${secretaria.dateNascimentoString}</td>
								<td><c:forEach var="telefone"
										items="${secretaria.telefones}">
	...
	<div class="pagination">
		<a
			href="${pageContext.request.contextPath}/view/admin/secretaria/listaSecretarias.do?pag=1"
			class="button"><span><img
				src="${pageContext.request.contextPath}/view/images/arrow-stop-180-small.gif"
				height="9" width="12" alt="First" />
			<fmt:message key="primeiro" /></span> </a> <a
			href="${pageContext.request.contextPath}/view/admin/secretaria/listaSecretarias.do?pag=<c:if test="${pag > 1}">${pag - 1}</c:if><c:if test="${pag == 1}">1</c:if>"
			class="button"><span> <img
				src="${pageContext.request.contextPath}/view/images/arrow-180-small.gif"
				height="9" width="12" alt="Previous" />
			<fmt:message key="anterior" /></span> </a>
		<div class="numbers">
			...
			<c:forEach var="i" begin="1" end="${numPags}">
				...
				<c:if test="${i != pag}">
					<a
						href="${pageContext.request.contextPath}/view/admin/secretaria/listaSecretarias.do?pag=${i}"><c:out
							value="${i}" /></a>
				</c:if>
				<c:if test="${i < numPags}">
					<span>|</span>
		...
		<a
			href="${pageContext.request.contextPath}/view/admin/secretaria/listaSecretarias.do?pag=<c:if test="${pag < numPags}">${pag + 1}</c:if> <c:if test="${pag == numPags}">${pag}</c:if>"
			class="button"><span><fmt:message key="proximo" /> <img
				src="${pageContext.request.contextPath}/view/images/arrow-000-small.gif"
				height="9" width="12" alt="Next" /></span> </a> <a
			href="${pageContext.request.contextPath}/view/admin/secretaria/listaSecretarias.do?pag=<c:out value="${numPags}"/>"
			class="button last"><span><fmt:message key="ultimo" /><img
