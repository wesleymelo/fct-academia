...
function retorna(id, descricao)
        {
		   ...
		   window.opener.document.getElementById('despesa').value = descricao;
        }
</script>
                        ...
                        <table id="myTable" class="tablesorter">
                        	<thead>
                                ...
                                <tr>
									...
									<th style="width: 36%"><fmt:message key="qtde" /></th>
                            ...
                            <tbody>
                             	<c:forEach var="despesa" items="${despesas}">
									<tr>
										<td class="align-center">${despesa.idDespesa}</td>
										<td><a
											href="javascript:retorna('${despesa.idDespesa}', '${despesa.descricao}');">${despesa.descricao}</a></td>
