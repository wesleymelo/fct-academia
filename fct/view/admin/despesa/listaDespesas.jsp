					...
					<table id="myTable" class="tablesorter">
						...
						<tbody>
							<c:forEach var="despesa" items="${despesas}">
								<tr>
									<td><a href="">${despesa.descricao}</a></td>
									<td><a href="">${despesa.quantidade}</a></td>
									<td><input type="checkbox" /> <a href=""><img
											...
											width="16" height="16" alt="published" /></a> <a href="${pageContext.request.contextPath}/view/admin/despesa/alteraDespesa.do?codigo=${despesa.idDespesa }"><img
