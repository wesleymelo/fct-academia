...
<div class="container_12">
	...
	<div class="grid_12">
		...
		<div class="module">
			 <h2><span><fmt:message key="cadastroDespesa" /></span></h2>         
					
			<div class="module-body">

				<form action="cadastroDespesa.do?codigo=${codigo }" method="post">
					...
					<p>
						<label><fmt:message key="qtde"/></label>
						<input type="text" class="input-short-short" name="qtde" id="qtde" value="${qtde}"/>
						<c:if test="${not empty erros['erroqtde'] }">
							<span class="notification-input ni-error"><fmt:message key="qtde_invalido"/></span>
						</c:if>
					</p>
