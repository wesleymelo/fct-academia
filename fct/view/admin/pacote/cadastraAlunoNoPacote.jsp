...
<div class="container_12">
	...
	<div class="grid_12">
		...
		<div class="module">
			<h2><span><fmt:message key="inserirAlunoPacote" /><c:out value=" ${pacote.descricao}"/></span></h2>
					
			<div class="module-body">

				<form action="cadastraAlunoNoPacote.do" method="post">
					...
					<p>
                        ...
                        <input type="text" value="${aluno}" class="input-short" name="aluno" id="aluno" readonly="readonly" value="${aluno}" /><a href="javascript:abrir('buscaAlunoPacote.do')"> <fmt:message key="buscar"/> </a>
	...
	<div style="clear: both;"></div>
		...
		<div class="module">
			<h2>
				<span><fmt:message key="turma" /><c:out value=": ${pacote.descricao}" /></span>
			</h2>
