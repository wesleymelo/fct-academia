...
{
	 window.location="cadastroModalidadeNoPacote.do"
     window.self.close();
}
</script>
	...
	<!-- Example table -->
                <div class="module">
                    ...
                    <div class="module-table-body">
                    	<form action="javascript:closeJanela('');">
                    	
                    	<!-- cadastroModalidadeNoPacote.do -->
	                        ...
	                        <table id="myTable" class="tablesorter">
	                        	<thead>
	                                ...
	                                <tr>
	                                	<th style="width: 1%"><fmt:message key="selecao"/></th>
	                                    <th style="width: 4%">#</th>
	                            ...
	                            <tbody>
	                             	<c:forEach var="modalidade" items="${modalidades}">
										<tr>
											<td class="align-center"><input type="checkbox" value="${modalidade.idModalidade }" name="check"></input></td>
											<td class="align-center">${modalidade.idModalidade}</td>
											<td class="align-center">${modalidade.descricao}</td>
										</tr>
									</c:forEach>
	                            </tbody>
	                       	</table>
	                       	
	                       	<input type="button" value="Inserir" onclick="javascript:closeJanela();"/> //botão
